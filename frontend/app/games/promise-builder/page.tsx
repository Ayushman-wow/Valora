...
function PromiseBuilderContent() {
...
export default function PromiseBuilderPage() {
    return (
        <Suspense fallback={<div className="min-h-screen flex items-center justify-center">Loading Promise Builder...</div>}>
            <PromiseBuilderContent />
        </Suspense>
    );
}
